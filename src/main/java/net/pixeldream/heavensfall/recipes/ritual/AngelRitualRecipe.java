...
public class AngelRitualRecipe implements Recipe<SingleRecipeInput>, RitualRecipeSerializer.RitualRecipeAccessor {
    private final Item centralItem;
    private final ItemMultiSet inputItems;
    private final ItemStack result;

    public AngelRitualRecipe(Item centralItem, ItemMultiSet inputItems, ItemStack result) {
    ...
    @Override
    public RecipeSerializer<?> getSerializer() { return HFRecipes.ANGEL_RITUAL_SERIALIZER.get(); }

    @Override
    public RecipeType<?> getType() { return HFRecipes.ANGEL_RITUAL_TYPE.get(); }
